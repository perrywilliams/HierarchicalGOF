...
The R code to replicate the sea otter analysis described in the
manuscript is provided in Appendix C of the manuscript. The sea otter data, and other
necessary functions for the analysis are stored in the HierarchicalGOF
package. Note this function requires use of RTools to install software
from a related github repository (So RTools must be installed).
